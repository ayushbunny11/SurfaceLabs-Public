...
from app.api.v1.endpoints.feature_apis import parse_github, analyze_repo, chat_apis
...
api_router.include_router(analyze_repo.router, prefix="/features", tags=["Functionality"])
